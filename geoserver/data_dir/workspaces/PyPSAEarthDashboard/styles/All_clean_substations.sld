...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se" version="1.1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink">
  <NamedLayer>
    <se:Name>all_clean_substations</se:Name>
    <UserStyle>
      <se:Name>all_clean_substations</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
            ...
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  ...
                  <se:SvgParameter name="fill-opacity">0.5</se:SvgParameter> <!-- Opacidad del relleno -->
                </se:Fill>
                <se:Stroke>
                  <se:SvgParameter name="stroke">#3d8035</se:SvgParameter>
                  <se:SvgParameter name="stroke-width">1</se:SvgParameter>
                  <se:SvgParameter name="stroke-opacity">0.5</se:SvgParameter> <!-- Opacidad del trazo -->
                </se:Stroke>
              </se:Mark>
              <se:Size>6</se:Size>
            </se:Graphic>
